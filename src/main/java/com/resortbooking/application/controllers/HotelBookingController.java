...
//
//    @PostMapping
//    public ResortBookingResponse<RoomsDto> createBooking(@RequestBody HotelBooking booking) {
//        try {
...
//            return new ResortBookingResponse<RoomsDto>(savedBooking, HttpStatus.CREATED);
