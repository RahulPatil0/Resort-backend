...
public class HotelController {
    ...
    public ResortBookingResponse<?> createHotel(@RequestBody HotelDto hotelDto) {
        ...
        try {
            // Validate emails
            if (!isValidEmail(hotelDto.getContactEmail())) {
                message = "Invalid contact email: " + hotelDto.getContactEmail();
                return new ResortBookingResponse<String>(message, HttpStatus.BAD_REQUEST);
            }
            if (hotelDto.getOwnerEmail() != null && !hotelDto.getOwnerEmail().isEmpty() && !isValidEmail(hotelDto.getOwnerEmail())) {
                message = "Invalid owner email: " + hotelDto.getOwnerEmail();
                return new ResortBookingResponse<String>(message, HttpStatus.BAD_REQUEST);
            }
    ...
    public ResortBookingResponse<?> updateHotel(@PathVariable Long id, @RequestBody HotelDto hotelDto) {
        ...
        try {
            // Validate emails before updating
            if (!isValidEmail(hotelDto.getContactEmail())) {
                message = "Invalid contact email: " + hotelDto.getContactEmail();
                return new ResortBookingResponse<String>(message, HttpStatus.BAD_REQUEST);
            }
