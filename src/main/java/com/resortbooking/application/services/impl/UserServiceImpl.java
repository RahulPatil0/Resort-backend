...
//
//	@Override
//	public User saveUser(User user) throws ResortBookingException {
    ...
    public String singIn(LoginRequest request) throws ResortBookingException {
        ...
        if (authentication != null) {
            User user = userRepository.findByEmail(request.getUsername())
                    .orElseThrow(() -> new ResortBookingException("User not found with email: " + request.getUsername()));
    ...
    public User saveUser(User user) throws ResortBookingException {
        try {
            ...
            if (user.getRoles() == null || user.getRoles().isEmpty()) {
                Optional<Roles> userRole = rolesRepository.findByRole("USER");
                userRole.ifPresent(r -> user.getRoles().add(r));
            }
            ...
            throw new ResortBookingException("Error saving user: " + e.getMessage());
        }
    }
}
